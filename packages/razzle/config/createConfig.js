...
module.exports = (
  ...
  return new Promise(async resolve => {
    ...
    configContext.babelOptions = modifyBabelOptions
      ? modifyBabelOptions(configContext.mainBabelOptions, {
          target,
          dev: IS_DEV,
        })
      : configContext.mainBabelOptions;
    ...
    // If it does, call it on the configContext we created.
    // Await promise if one is returned.
    configContext = modifyConfigContext
