# Razzle Custom Promise Configuration Example
...
```bash
node_modules/.bin/create-razzle-app --example file:examples/with-promise-config with-promise-config --no-install
